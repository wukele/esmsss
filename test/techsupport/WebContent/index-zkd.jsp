	...
	function xiazailixian(){
		if(content_urls!=null&&content_urls!=''&&content_urls!='null'){
			...
			for(var i=0;i<utype.length;i++){
				if(userid!=null&&(utype[i]=="13"||utype[i]=="143"||utype[i]=="122")){ //用户对象不为空、且为企业端用户 则下载offline
...
<!--					<a class="headlink" href="#" id='sytz_button' onclick="loadZkd();">台帐</a>-->
      ...
      <tr>
        <td></td>
        <td valign="top" class="smalltitlefont" >制卡端信息系统</td>
      </tr>
    </table></td>
  </tr>
</table>
