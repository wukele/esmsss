...
var hylbdm = $("#hylbdm").val();
	...
	function addVerify(){	
	    if (!checkControlValue("a_qymc","String",1,200,null,1,"所属企业"))
			return false;
...
<input type="hidden" id="a_cyrylbdm" value="0"/>
<input type="hidden" id="a_cyrylbmc" value='国内从业人员'/>
...
<table width="100%" cellpadding="2" cellspacing="0" id="add" border="0">
	<tr height="20">
		...
		<td class="detailtd"><select type="select" id="a_hylbdm"></select></td>
		<td class="red">所属企业</td>
		<td class="detailtd"><input type="text" class="inputstyle" id="a_qymc"/><input type="hidden" class="inputstyle" id="a_qybm"/></td>
    </tr>
	<tr height="20">
		...
		<td width="22%" rowspan="13" align="center" valign="top">
	...
	<tr height="20">
		...
		<td colspan="3" class="detailtd"><input type="text" style="width:490" id="a_hjdxz" class="inputstyle3"/></td>
	</tr>
	<tr height="20">
	...
	<tr height="20">
		...
		<td colspan="3" class="detailtd"><input type="text" style="width:490" class="inputstyle3" id="a_zzdz"/></td>
	</tr>
	<tr height="20">
