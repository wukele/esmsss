...
<script type="text/javascript">
	...
	function qyjbxx_addVerify_yzhy(){ //验证
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
		        ...
		        <td id="jyxk_fzjgConte" class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="a_jyxkFzjg"
		        	onkeyup="htjdOnkeyupVal('a_jyxkFzjg','zhongwen');"/>
		        	<input style="width:120px" type="hidden" id="a_jyxkFzjgdm"/>
		        	</td>
		</tr>
			<tr height="25">
			...
			<tr height="25">
				...
				<td class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="a_nsrq"/></td>
			</tr>
			<tr height="25">
