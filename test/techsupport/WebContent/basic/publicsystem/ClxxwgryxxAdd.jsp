...
<script type="text/javascript">
	...
	function addVerify(){
		if (!checkControlValue("a_cljbxxid","Integer",-9999999999,9999999999,null,0,"车辆基本信息ID"))
			return false;
		if (!checkControlValue("a_wgrxxid","Integer",-9999999999,9999999999,null,0,"外国人信息ID"))
			return false;
		if (!checkControlValue("a_wgrylb","String",1,2,null,0,"外国人员类别"))
			return false;
...
<table width="100%" id="add">
	<tr height="20">
		...
		<td class="detailtd"><input type="text" id="a_wgrxxid" value="0"></td>
	</tr>
	<tr height="20">
		<td class="distd">外国人员类别</td>
		<td class="detailtd"><input type="text" id="a_wgrylb" value=""></td>
