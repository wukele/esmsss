...
<script type="text/javascript">
	...
	function qyjbxx_addVerify_wtjm(){ //验证
		if (!checkControlValue("a_qymc","String",1,120,null,1,"经营名称"))
			return false;
		...
		if (!checkControlValue("a_jymj","Float",-99999999.99,99999999.99,2,1,"占地面积(平米)"))
			return false;
		if (!checkControlValue("a_zczj","Float",-99999999.99,99999999.99,2,0,"注册资本(万元)"))
			return false;
		...
		if (!checkControlValue("a_yyzzFzjg","String",1,60,null,0,"营业执照发证机关"))
			return false;
		if (!checkControlValue("a_djrq","Date",null,null,null,0,"营业执照发证日期"))
			return false;
	...
	$("#a_dwfzrzjhm").blur(function(){
		var zjhmValue = $(this).val();
		if(!checkIdCardNo("a_dwfzrzjhm")){
			jAlert("“经营负责人身份证码”不正确！","提示信息");
		}
	});

	$("#a_bafzrgmsfhm").blur(function(){
		var zjhmValue = $(this).val();
		if(!checkIdCardNo("a_bafzrgmsfhm")){
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
		        ...
		        <td class="pagetd1"><input style="width:120px" type="text" class="inputstyle3" id="a_djrq"/></td>
			...
			<tr height="25">
				...
				<td id="bz_conte" colspan="7" class="pagetd1"><textarea name="textarea" id="a_bz" cols="102" rows="5"></textarea></td>
			</tr>
			</table>
		</td>
		</tr>
