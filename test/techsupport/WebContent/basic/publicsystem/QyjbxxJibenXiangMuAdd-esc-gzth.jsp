...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#a_sfazsxt").selectBox({code:"dm_bez",width:"118px"});
		$("#bq_frdbzj").setText('居民身份证');
		$("#a_frdbzjlb").attr("value",$("#bq_frdbzj").attr('title'));
	...
	function qyjbxx_addVerify_esc(){ //验证
		...
		if (!checkControlValue("a_jymj","Float",-99999999.99,99999999.99,2,0,"占地面积"))
			return false;
		if (!checkControlValue("a_zczj","Float",-99999999.99,99999999.99,2,0,"注册资本"))
			return false;
		...
		if (!checkControlValue("a_thbajg","String",1,60,null,1,"特行备案管理机构"))
			return false;
		if (!checkControlValue("a_jyxkZjbh","String",1,60,null,0,"行业许可证号"))
			return false;
		if (!checkControlValue("a_jyxkFzjg","String",1,60,null,0,"行业许可证发证机构名称"))
			return false;
		if (!checkControlValue("a_jyxkFzjgdm","String",1,60,null,0,"行业许可证发证机构代码"))
			return false;
		...
		if (!checkControlValue("a_dwfzr","String",1,30,null,1,"单位负责人"))
			return false;
		if (!checkControlValue("a_dwfzrzjhm","String",1,30,null,1,"单位负责人身份号码"))
			return false;
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
		        ...
		        <td class="pagedistd1">注册资本（万元）</td>
			...
			<tr height="25">
		        ...
		        <td class="pagetd1" style='display:none;'><input style="width:120px" type="text" class="inputstyle1" id="a_babh"/></td>
                </tr>			
			<tr height="25">
			...
			<tr height="25">
				...
				<td class="pagetd1" style='display:none;'><input style="width:120px" type="text" class="inputstyle1" id="a_jyxkFzjgdm"/></td>
			...
			<tr height="25">
				<td class="red"  nowrap>治安负责人联系方式</td>
				<td class="pagetd1"  colspan="5" ><input style="width:120px" type="text" class="inputstyle1" id="a_bafzrdh"/></td>
				
			</tr>
			<tr height="25" style='display:none;'>
				<td class="red">保卫部门电话</td>
				<td class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="a_bwbmdh"/></td>
				<td class="red">是否安装摄像头</td>
				<td class="pagetd1"><select id="a_sfazsxt"><option></option></select></td>
				<td class="pagedistd1">摄像头数量</td>
				<td class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="a_azsxtsl"/></td>
			</tr>
			<tr>
