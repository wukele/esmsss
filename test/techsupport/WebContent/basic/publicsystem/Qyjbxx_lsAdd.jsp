...
<script type="text/javascript">
	...
	function addVerify(){
		...
		if (!checkControlValue("a_ssdxjgajgmc","String",1,200,null,0,"所属地县级公安机关名称"))
			return false;
		if (!checkControlValue("a_ssdpcsjgdm","String",1,20,null,0,"所属地派出所机构代码"))
			return false;
		if (!checkControlValue("a_ssdpcsjgmc","String",1,200,null,0,"所属地派出所机构名称"))
			return false;
		...
		if (!checkControlValue("a_jjlxmc","String",1,60,null,0,"经济类型名称"))
			return false;
		if (!checkControlValue("a_jyfwzy","String",1,200,null,0,"经营范围（主营）"))
			return false;
		...
		if (!checkControlValue("a_zajbmc","String",1,20,null,0,"治安级别名称"))
			return false;
		if (!checkControlValue("a_yyztdm","String",1,20,null,0,"营业状态代码"))
			return false;
...
<table width="100%" id="add">
	...
	<tr height="20">
		...
		<td class="detailtd"><input type="text" id="a_ssdpcsjgdm" value=""></td>
		<td class="distd">所属地派出所机构名称</td>
		<td class="detailtd"><input type="text" id="a_ssdpcsjgmc" value=""></td>
	</tr>
	<tr height="20">
