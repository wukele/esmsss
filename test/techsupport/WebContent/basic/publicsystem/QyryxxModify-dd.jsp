...
var hylbdm = $("#hylbdm").val();
	...
	function updatediv (json) { 
		...
		$("#m_csid").val(setNull(json.LQyryxx[0].csid));
...
<table width="100%" cellpadding="2" cellspacing="0" id="add">
	<tr height="20">
		...
		<td width="27%" rowspan="10" align="center" valign="top">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="but">
  <tr align="center">
    <td>
    <a href="#" id="wtgyy" style="display: none" hidefocus="true" class="submitlongbutton" title="审核记录" onclick='shhistroy();'>审核记录</a>
