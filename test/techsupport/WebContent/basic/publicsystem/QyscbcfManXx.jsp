...
<script type="text/javascript">
  var tablesxx;
    var thePlayColWidthsxx1 = ["12.5%","12.5%","12.5%","12.5%","12.5%","12.5%","12.5%","12.5%"];
    var thePlayColWidthsxx2 = ["15%","11%","21%","6%","6%","11%","11%","11%","8%"];
    ...
    var ganjColxx="";
       if(jb!=null&&jb!=''){
		...
		resultxx += "<th name='l_zrs' datatype='Integer' sumflag='0'>总人数</th>";
		resultxx += "<th name='l_sskrs' datatype='Integer' sumflag='0'>实刷卡人数</th>";
		resultxx += "<th name='l_lxdh' datatype='Integer' sumflag='0'>联系电话</th>";
		resultxx += "<th name='l_hdskbstring' datatype='Integer' sumflag='0'>核定刷卡比(%)</th>";
		resultxx += "<th name='l_sjsrbstring' datatype='Integer' sumflag='0'>实际刷卡比(%)</th>";
	    resultxx += "<th name='l_wdbrq' datatype='Integer' sumflag='0'>未达标日期</th>";
...
$(document).ready(function() {
    createDataTablexx();
	pageUrlxx="publicsystem/querylistxx_qyscbcf.action";
	divnidxx="tabledata2";
	tableidxx="table2";
	loadPagexx("tabledata2");
	
	//ExcelURL
	excelUrlxx="publicsystem/querylistExcelxx_qyscbcf.action";
	searchLongUrlxx="publicsystem/querylistExcelTempxx_qyscbcf.action";
}); 
 ...
 function loadPagexx(divpageid){
  ...
  function closeAndRemove(){
	$("#qyscbcfxx_detail").children().remove();
	$("#qyscbcfxx_detail").hideAndRemove("show");
}
</script>
</head>
<body>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      <td align="left" class="title1">场所上传不充分详细信息</td>
...
<div id="tabledata2" style="width:100%;">
	<table id="table2" width="100%">
	  <thead>
		...
		<th name='l_zrs' datatype='Integer' sumflag='0'>总人数</th>
		<th name='l_sskrs' datatype='Integer' sumflag='0'>实刷卡人数</th>
		<th name='l_lxdh' datatype='Integer' sumflag='0'>联系电话</th>
		<th name='l_hdskbstring' datatype='Integer' sumflag='0'>核定刷卡比(%)</th>
		<th name='l_sjsrbstring' datatype='Integer' sumflag='0'>实际刷卡比(%)</th>
		<th name='l_wdbrq' datatype='Integer' sumflag='0'>未达标日期<</th>
	    </tr>
	  </thead>
	</table>
</div>
