...
<script type="text/javascript">
	...
	function qyjbxx_modifyVerify_qczl(){ //验证
		...
		if (!checkControlValue("m_kyrq","Date",null,null,null,1,"开业日期"))
			return false;
		if (!checkControlValue("m_zczj","Float",-99999999.99,99999999.99,2,1,"注册资本"))
			return false;
		...
		if (!checkControlValue("m_frdb","String",1,30,null,1,"法定代表人"))
			return false;
		if (!htjdOnBlurNotOnlyZfVal('m_qyzzjgdm','jyxk','1','‘组织机构编码’','1','0')){
			return false;
		}
		if (!checkControlValue("m_qyzzjgdm","String",1,10,null,0,"组织机构编码"))
			return false;
		if (!checkControlValue("m_frdbzjhm","String",1,30,null,1,"法人证件号码"))
			return false;
		if (!checkControlValue("m_frdblxfs","String",1,30,null,1,"法人联系方式"))
			return false;
		if (!checkControlValue("m_babh","String",1,30,null,0,"特行备案编号"))
			return false;
		if (!checkControlValue("m_thbajg","String",1,60,null,0,"特行备案机构"))
			return false;
		if (!checkControlValue("m_jyxkZjbh","String",1,60,null,0,"经营许可证号"))
			return false;
		if (!checkControlValue("m_jyxkFzjg","String",1,60,null,0,"经营许可证发证机构名称"))
			return false;
		if (!checkControlValue("m_jyxkFzjgdm","String",1,60,null,0,"经营许可证发证机构代码"))
			return false;
		if (!checkControlValue("m_yyzzZjbh","String",1,60,null,1,"营业执照编号"))
			return false;
		if (!checkControlValue("m_yyzzFzjg","String",1,60,null,1,"营业执照发证机关"))
			return false;
		if (!checkControlValue("m_swdjZjbh","String",1,60,null,1,"税务登记证编号"))
			return false
		if (!checkControlValue("m_swdjFzjg","String",1,60,null,1,"税务登记证发证机关"))
			return false;
		if (!checkControlValue("m_dwfzr","String",1,30,null,1,"单位负责人"))
			return false;
		if (!checkControlValue("m_dwfzrlxfs","String",1,30,null,1,"负责人联系方式"))
			return false;
		if (!checkControlValue("m_dwfzrzjhm","String",1,30,null,1,"负责人公民身份号码"))
			return false;
		if (!checkControlValue("m_bafzrxm","String",1,30,null,1,"治安负责人"))
			return false;
		if (!checkControlValue("m_bwbmdh","String",1,30,null,1,"保卫部门电话"))
			return false;
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
		        ...
		        <td class="pagetd1" colspan="3"><input style="width:460px" type="text" class="inputstyle1" id="m_qymc"/></td>
			</tr>
			<tr height="25">
		        ...
		        <td class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="m_jyfwzy"/></td>
			</tr>
			<tr height="25">
		        <td class="red" width="12%">联系电话</td>
		        <td class="pagetd1" width="14%"><input style="width:120px" type="text" class="inputstyle1" id="m_lxdh"/></td>
		        <td class="pagedistd1" width="20%">传真</td>
				<td class="pagetd1" width="20%"><input style="width:120px" type="text" class="inputstyle1" id="m_chzh"/></td>
		        <td class="pagedistd1" width="11%">邮政编码</td>
		        <td class="pagetd1" width="15%"><input style="width:120px" type="text" class="inputstyle1" id="m_yzbm" maxlength="6" onKeyUp="value=value.replace(/[^\d]/g,'')"/></td>
            </tr>
			<tr height="25">
		        <td class="red" width="11%">开业日期</td>
		        <td class="pagetd1" width="14%"><input style="width:120px" type="text" class="inputstyle1" id="m_kyrq"/></td>
		        <td class="red" width="11%">注册资本（万元）</td>
		        <td class="pagetd1" width="14%"><input style="width:120px" type="text" class="inputstyle1" id="m_zczj"/></td>
			...
			<tr height="25">
				...
				<td class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="m_jyxkFzjgdm"/></td>
			...
			<tr height="25">
				...
				<td class="pagetd1" colspan="3"><input style="width:120px" type="text" class="inputstyle1" id="m_bwbmdh"/></td>
			</tr>
			<tr>
