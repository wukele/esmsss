...
<input type="hidden" id="jjlxbm"/>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
				<td class="distd1" width="12%">经济类型</td>
		        <td class="detailtd2" width="13%"><span id="jjlxmc"></span></td>
			...
			<tr height="25">
		        ...
		        <td class="detailtd2" width="132px"><span id="frdbzjlb"></span></td>
