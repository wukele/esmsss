...
<script type="text/javascript">
	...
	function qyjbxx_modifyVerify_esc(){ //验证
		...
		if (!checkControlValue("m_jjlxmc","String",1,100,null,1,"经济类型"))
			return false;
		if (!checkControlValue("m_jymj","Float",-99999999.99,99999999.99,2,0,"占地面积"))
			return false;
		if (!checkControlValue("m_zczj","Float",-99999999.99,99999999.99,2,0,"注册资本"))
			return false;
		...
		if (!checkControlValue("m_jyxkFzjg","String",1,60,null,0,"行业许可证发证机构名称"))
			return false;
		if (!checkControlValue("m_jyxkFzjgdm","String",1,60,null,0,"行业许可证发证机构代码"))
			return false;
		...
		if (!checkControlValue("m_dwfzr","String",1,30,null,1,"单位负责人"))
			return false;
		if (!checkControlValue("m_dwfzrzjhm","String",1,30,null,1,"单位负责人身份号码"))
			return false;
		...
		if (!checkControlValue("m_bafzrdh","String",1,30,null,1,"治安负责人联系方式"))
			return false;
		if (!checkControlValue("m_bwbmdh","String",1,30,null,0,"保卫部门电话"))
			return false;
		if (!checkControlValue("m_sfazsxt","Select",1,30,null,0,"是否安装摄像头"))
			return false;
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
		        ...
		        <td class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="m_swdjFzjg"
		        	onkeyup="htjdOnkeyupVal('m_swdjFzjg','zhongwen');"/><input type="hidden" id="m_thbajgdm"/></td>	
			...
			<tr height="25">
				...
				<td class="pagetd1" colspan="5"><input style="width:120px" type="text" class="inputstyle1" id="m_bafzrdh"/></td>
			</tr>
