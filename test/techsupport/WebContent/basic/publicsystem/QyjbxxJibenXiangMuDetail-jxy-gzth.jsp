...
<BODY>
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25"> 
				<td class="distd1" style='display:none'>特行备案编号</td>
		        <td class="detailtd2" style='display:none' width="132px"><span id="babh"></span></td>       
				<td class="distd1">经营许可证号</td>
			...
			<tr height="25">
		        ...
		        <td class="distd1" nowrap>单位负责人身份证号</td>
			...
			<tr height="25">				
		        <td class="distd1"><span nowrap>保安人员数量</span></td>
		        <td class="detailtd2"  width="132px"><span id="barysl"></span></td>
				<td class="distd1"><span nowrap>保卫人员数量</span></td>
				<td class="detailtd2"  width="132px"><span id="bwrysl"></span></td>
				<td class="distd1" nowrap>登记人</td>
			...
			<tr height="25">
				...
				<td class="detailtd2" ><span id="lrsj" width="132px"></span></td>
			</tr>
			<tr style='display:none'>
				<td class="distd1">保卫部门电话</td>
				<td class="detailtd2" width="132px" colspan="5"><span id="bwbmdh"></span></td>
			</tr>
			<tr>
				<td id="bz_title" class="distd1">备注</td>
				<td id="bz_conte" colspan="5" class="detailtd2" width="865px"><span id="bz"></span></td>
			</tr>
			</table>
		</td>
		</tr>
