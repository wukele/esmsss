...
<script type="text/javascript">
	...
	function qyjbxx_addVerify_esj(){ //验证
		...
		if (!checkControlValue("a_bwbmdh","String",1,30,null,1,"保卫部门电话"))
			return false;
		if (!checkControlValue("a_sfazsxt","Select",1,30,null,1,"是否安装摄像头"))
			return false;
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
		        ...
		        <td class="pagetd1" colspan="3"><input style="width:460px" type="text" class="inputstyle1" id="a_qymc"/></td>
			</tr>
			<tr height="25">
