	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
		        ...
		        <td class="detailtd2" width="14%" ><span id="lxdh" width="132px"></span></td>
		        <td class="distd1" width="20%">传真</td>
				<td class="detailtd2" width="20%" ><span id="chzh" width="132px"></span></td>
		        <td class="distd1" width="11%">邮政编码</td>
		        <td class="detailtd2" width="15%" ><span id="yzbm" width="132px"></span></td>
           </tr>
			<tr height="25">
		        <td class="distd1">开业日期</td>
		        <td class="detailtd2" ><span id="kyrq" width="132px"></span></td>
		        <td class="distd1" >注册资本（万元）</td>
		        <td class="detailtd2"  ><span id="zczj" width="132px"></span></td>
			...
			<tr height="25">
		        ...
		        <td class="distd1">行业许可证<br>发证机构代码</td>
				<td class="detailtd2" width="132px"><span id="jyxkFzjgdm"></span></td>
			...
			<tr height="25">
				...
				<td class="detailtd2" width="132px" colspan="3" ><span id="bwbmdh"></span></td>
			</tr>
			<tr>
