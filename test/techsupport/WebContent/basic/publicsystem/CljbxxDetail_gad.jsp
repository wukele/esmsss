...
<span id="closeClspan"></span>
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" id="qczlkhxx">
    <tr>
      <td align="left" class="title1">车辆基本信息详情</td>
      <td align="right" class="title1"><a href="#" id="closeDiv" onclick='$("#closeClspan").parent().hideAndRemove("show");' class="close"></a></td>
    </tr>
</table>
	...
	<table width="100%"  border="0" cellpadding="1" cellspacing="0" class="detail" id="detail">
		...
		<tr>
			<td width="12%" class="distd1">车主姓名</td>
			<td width="21%" class="detailtd2"><span id="czm"></span></td>
			<td width="12%" class="distd1">性别</td>
			<td width="21%" class="detailtd2"><span id="czxb"></span></td>
			<td width="12%" class="distd1">电话</td>
