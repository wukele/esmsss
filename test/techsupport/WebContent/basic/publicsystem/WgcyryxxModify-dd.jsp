...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td align="left" class="title1">外国从业人员修改</td>
...
<table width="100%" id="modify">
	<tr>
		...
		<td width="21%" class="detailtd"><input type="text" class="readonly" id="m_xm" readonly/></td>
	...
	<tr>
		<td class="red">英文姓</td>
		<td class="detailtd"><input type="text" class="inputstyle" id="m_ywx" /></td>
		<td  class="red">英文名</td>
		<td class="detailtd"><input type="text" class="inputstyle" id="m_ywm" /></td>
    </tr>
	<tr height="20">
		<td class="red">性别</td>
		<td class="detailtd"><input type="hidden" id="m_xb"/><select id="m_xbdm"></select></td>
		<td class="red">出生日期</td>
		<td class="detailtd"><input type="text" class="inputstyle" id="m_csrq"/></td>
	</tr>
	<tr height="20">
		<td class="red">国籍</td>
		<td class="detailtd"><input type="text" id="m_gj" class="inputstyle" readonly/><input type="hidden" id="m_gjdm"/></td>
		<td class="distd">婚姻状况</td>
		<td class="detailtd"><select id="m_hyzkdm"></select></td>
	</tr>
  	<tr height="20">
		<td class="red">就业许可证号</td>
		<td class="detailtd"><input type="text" class="inputstyle" id="m_wgrjyxkz" /></td>
		<td class="red">入职日期</td>
		<td class="detailtd"><input type="text" class="inputstyle" id="m_rzrq" /></td>
    </tr>
	<tr height="20">
		<td class="red">证件类型</td>
		<td class="detailtd"><select id="m_cyzjdm"><option></option></select><input type="hidden" id="m_cyzj"/></td>
		<td class="red">证件号码</td>
		<td class="detailtd"><input type="text" class="inputstyle"  id="m_zjhm" /></td>
    </tr>
	<tr height="20">
		<td class="red">签证类型</td>
		<td class="detailtd"><select id="m_qzzldm"><option></option></select></td>
		<td class="red">签证号码</td>
		<td class="detailtd"><input type="text" class="inputstyle" id="m_qzhm" /></td>
    </tr>
	<tr height="20">
	...
	<tr height="20">
		...
		<td colspan="4" class="detailtd"><input class="inputstyle3" type="text" style="width:493" id="m_zzdz" /></td>
	</tr>
	<tr height="20">
		<td class="distd" valign="top">备注 </td>
		<td colspan="4" class="detailtd"><textarea id="m_bz" cols="76" rows="3"></textarea></td>
	</tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="but">
  <tr align="center">
    ...
    <a href="#" id="addbutton" hidefocus="true" class="submitbutton" title="保存" onclick='setUpdate_wgcyry();'>保存</a>
    </td>
  </tr>
</table>
