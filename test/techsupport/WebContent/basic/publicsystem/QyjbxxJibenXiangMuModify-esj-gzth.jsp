...
<script type="text/javascript">
	...
	function qyjbxx_modifyVerify_esj(){ //验证
		...
		if (!checkControlValue("m_thbajg","String",1,60,null,0,"特行备案机构"))
			return false;
		if (!checkControlValue("m_jyxkZjbh","String",1,60,null,0,"行业许可证号"))
			return false;
		if (!checkControlValue("m_jyxkFzjg","String",1,60,null,0,"行业许可证发证机构名称"))
			return false;
		...
		if (!checkControlValue("m_bwbmdh","String",1,30,null,1,"保卫部门电话"))
			return false;
		if (!checkControlValue("m_sfazsxt","Select",1,30,null,1,"是否安装摄像头"))
			return false;
		if (!checkControlValue("m_azsxtsl","Integer",0,999999,null,0,"摄像头数量"))
			return false;
...
<input type="hidden" id="m_jjlxbm"/>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr  height="25">
		        <td class="pagedistd1">行业许可证<br>发证机构名称</td>
