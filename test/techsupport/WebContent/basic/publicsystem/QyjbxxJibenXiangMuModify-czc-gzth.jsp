...
<script type="text/javascript">
	...
	function qyjbxx_modifyVerify_czc(){ //验证
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
		        ...
		        <td class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="m_kyrq"/></td>
			...
			<tr height="25">
				...
				<td id="bz_conte" colspan="5" class="pagetd1"><textarea name="textarea" id="m_bz" cols="102" rows="2"></textarea></td>
			</tr>
			</table>
		</td>
		</tr>
