...
<script type="text/javascript">
	...
	daggleDiv(detailid);
		$("#a_wscrq").attr("readonly","true");
		$("#a_wscrq").datepicker();
	}); 
	function addVerify(){
		if (!checkControlValue("a_wscqyid","Integer",-9999999999,9999999999,null,0,"未上传企业ID"))
			return false;
		if (!checkControlValue("a_hylbdm","String",1,2,null,0,"行业类别代码"))
			return false;
		if (!checkControlValue("a_hylb","String",1,40,null,0,"行业类别"))
			return false;
		if (!checkControlValue("a_wscrq","Date",null,null,null,0,"未上传日期"))
			return false;
...
<table width="100%" id="add">
	<tr height="20">
		...
		<td class="detailtd"><input type="text" id="a_wscqyid" value="0"></td>
	...
	<tr height="20">
		...
		<td class="detailtd"><input type="text" id="a_wscrq" value=""></td>
	</tr>
	<tr height="20">
