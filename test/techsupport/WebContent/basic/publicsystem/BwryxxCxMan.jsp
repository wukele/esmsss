...
<script type="text/javascript">
	$(document).ready(function() {
		pageUrl="publicsystem/queryCxlist_bwryxx.action";
		divnid="BwryxxcxData";
		tableid="BwryxxcxTable";
		addUrl="publicsystem/insert_bwryxx.action";
		addHtml="basic/publicsystem/BwryxxCxAdd.jsp";
		addWidth="600";
		delUrl="publicsystem/delete_bwryxx.action";
		delid="d_bwryxxcxid";
		modHtml="basic/pubilcsystem/BwryxxCxModify.jsp";
		modUrl="publicsystem/modify_bwryxx.action";
		modWidth="600";
		detailHtml="basic/publicsystem/BwryxxCxDetail.jsp";
		detailid="bwryxxcx_detail";
...
<head>
<body>
<input type="hidden" id="p_bwryxxid"/>
...
<table width="100%" cellpadding="0" cellspacing="0"  class="tableborder">
	<tr>
    <td class="queryfont">保卫人员信息查询</td>
	</tr>
	<tr>
		<td class="tdbg">
...
<div id="bwryxxcx_detail" class="page-layout" src="#" style="top:60px;"></div>

<div id="BwryxxcxData" style="width:100%;">
	<table id="BwryxxcxTable" width="100%">
	  <thead>
	    <tr>   
