...
<script type="text/javascript">
	...
	function updatediv (json) { 
		$("#m_zjid").attr("value",setNull(json.LQyzjb[0].zjid));
		$("#m_qyid").attr("value",setNull(json.LQyzjb[0].qyid));
		$("#m_zjfl").attr("value",setNull(json.LQyzjb[0].zjfl));
		$("#m_zjbh").attr("value",setNull(json.LQyzjb[0].zjbh));
		$("#m_fzjg").attr("value",setNull(json.LQyzjb[0].fzjg));
		$("#m_qsrq").attr("value",setNull(json.LQyzjb[0].qsrq));
		$("#m_jzrq").attr("value",setNull(json.LQyzjb[0].jzrq));
	}	
	function modifyVerify(){
		if (!checkControlValue("m_zjid","Integer",-9999999999,9999999999,null,0,"证件ID"))
			return false;
...
<input type="hidden" id="m_zjid">
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      <td align="left" class="title1">修改</td>
      <td ><a href="#" id="closeDiv" onclick='$("#Qyzjb_detail").hideAndRemove("show");' class="close"></a></td>
    </tr>
</table>
<table width="100%" id="modify">
	<tr height="20">
		<td class="distd">证件ID</td>
		<td class="detailtd"><input type="text" id="m_zjid" value="0"></td>
