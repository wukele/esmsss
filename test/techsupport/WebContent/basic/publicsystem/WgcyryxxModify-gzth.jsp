...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var hylbdm = "<%=yhlb %>";
		if(hylbdm=="E03"){
			detail_div_loadHtml = "basic/publicsystem/WgcyryxxModify-dd.jsp";
		}else{
			detail_div_loadHtml = "basic/publicsystem/WgcyryxxModify.jsp";
		}
		$("#wgcyryxx_detail_div").load(detail_div_loadHtml);
	});
</script>
