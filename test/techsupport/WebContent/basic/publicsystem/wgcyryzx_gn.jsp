...
<script type="text/javascript">
	...
	function updatediv(json) { 
		$("#m_cyrybh").attr("value",setNull(json.LWgcyryxx[0].cyrybh));
		$("#m_qyid").attr("value",setNull(json.LWgcyryxx[0].qyid));
...
function setUpdateZxwgry(){
	if (modifyVerify()){
		setParams("m_");
		jQuery.post(modUrl,params,updatebackwgry,"json"); 
		return true;
	}else{
		return false;
	}		
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      ...
      <td align="right" class="title1"><a href="#" id="closeDiv" onclick='$(&quot;#wgcyryxx_detail&quot;).hideAndRemove(&quot;show&quot;);'class="close"></a></td>
    </tr>
</table>
		...
		<td colspan="2"  align="right"><table width="60" border="0" align="center" cellpadding="2" cellspacing="0">
          <tr>
            <td><a href="#" id="addbutton" hidefocus="true" class="submitbutton"
				title="保存" onclick='setUpdateZxwgry();'>保存</a></td>
            <td><a href="#" id="addbutton2" hidefocus="true" class="submitbutton"
				title="取消" onclick='$(&quot;#wgcyryxx_detail&quot;).hideAndRemove(&quot;show&quot;);'>取消</a></td>
          </tr>
        </table></td>
</tr>
</table>
