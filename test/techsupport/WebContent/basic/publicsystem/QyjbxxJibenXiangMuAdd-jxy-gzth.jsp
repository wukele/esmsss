...
<script type="text/javascript">
	...
	function qyjbxx_addVerify_jxy(){ //验证
...
<input type="hidden" id="a_jjlxbm"/>
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr>
				<td class="pagedistd1" style='display:none;'>保卫部门电话</td>
				<td class="pagetd1" style='display:none;' colspan="5"><input style="width:120px" type="text" class="inputstyle1" id="a_bwbmdh"/></td>
			</tr>
			<tr height="25">
