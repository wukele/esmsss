...
$(document).ready(function() {
	...
	pageUrl="publicsystem/querylist_wscqy.action";
	divnid="tabledata";
	tableid="table1";
	loadPage("tabledata");
	...
	//ExcelURL
	excelUrl="publicsystem/querylistExcel_wscqy.action";
	searchLongUrl="publicsystem/querylistExcelTemp_wscqy.action";
	 daggleDiv("wscxx_detail");
    ...
    function createDataTable(){
		...
		result += "<th name='l_wscts' datatype='Integer' sumflag='0'>未上传天数</th>";
   ...
   function setScbcfxxQuery(id,qybms){
         setXParmValue(id);
	     detailid="wscxx_detail";
	     $('#'+detailid).css('left','5').css('top','50');
	     $("#x_qybm").attr("value", qybms);
		 var url="basic/publicsystem/WscqyManXx.jsp";
	     setUrl(detailid,url);
	    
	     //  $("#x_tjjbdm").attr("value", id);
	}
...
<!--  
<input type="hidden" id="x_tjjbdm">
-->

<table width="100%" cellpadding="0" cellspacing="0"  class="tableborder">
  <tr>
    <td class="queryfont">场所未上传信息统计</td>
  </tr>
  <tr>
...
<div id="wscxx_detail" class="page-layout" src="#" style="top:20px; left:160px; width:1000px;"></div>
...
<div id="tabledata" style="width:100%;">
	<table id="table1" width="100%">
	  <thead>
		...
		<th name='l_wscts' datatype='Integer' sumflag='0'>未上传天数</th>
