...
<script type="text/javascript">
	...
	$('#a_hylbdm').change(function(){
	    ...
	    if(publicHylbdm == 'N'){// 典当业
	    }else if(publicHylbdm == 'E03'){ //内保单位
	        selectHylbPage("basic/publicsystem/WgcyryxxAdd-gad-dd.jsp");
	    }else{
	    	selectHylbPage("basic/publicsystem/WgcyryxxAdd-gad.jsp");
	    }
	...
	function valCyryZjhmBack(json){
		if(json.result=="success"){
			if(json.exitResult=="1"){
				jAlert('此证件号码已存在!','验证信息',null,'a_zjhm');
				canCommit=false;
			}else{
				canCommit=true;
			}
...
<table width="100%" cellpadding="2" cellspacing="0" id="add">
    <tr height="20">
		...
		<td class="detailtd"><input type="text" class="inputstyle" id="a_qymc" readonly/><input type="hidden" class="inputstyle" id="a_qybm"/></td>
    </tr>
	<tr height="20">
	...
	<tr height="20">
		...
		<td class="detailtd"><select name="select5" id="a_hyzkdm"><option></option></select></td>
	</tr>
  	<tr height="20">
	...
	<tr height="20">
		...
		<td colspan="3" class="detailtd"><input type="text" class="inputstyle3" style="width:493" id="a_zzdz" /></td>
	</tr>
	<tr height="20">
