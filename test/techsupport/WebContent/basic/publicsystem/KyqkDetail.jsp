...
<table width="100%"  cellpadding="4" cellspacing="0" class="detail" id="detail" >
	<tr height="20">
		...
		<td width="65%" class="detailtd2"><span  style="word-break : break-all; width:100px;  "
		 id="djxh"></span></td>
		<td width="15%" class="distd1">可疑情况类型</td>
		<td width="25%" colspan="3" class="detailtd2"><span id="kyqklx"></span></td>
	...
	<tr height="20">
		...
		<td colspan="5" class="detailtd2">
		  <textarea name="textarea" id="ydxxms"  cols="66" rows="5" readonly="true" ></textarea>    </td>
	</tr>
</table>
