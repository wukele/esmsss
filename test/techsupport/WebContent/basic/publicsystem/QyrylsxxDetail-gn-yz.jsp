...
<table width="100%"  cellpadding="1" cellspacing="0" class="detail" id="detail" >
	<tr height="20">
      ...
      <td colspan="2" rowspan="8" align="center" valign="top" class="detailtd2"><table border="0" align="center" cellpadding="8" cellspacing="0">
    ...
    <tr height="20">
		<td class="distd1" width="11%">紧急联系电话</td>
		<td class="detailtd2" width="23%"><span id="qtlxdh"></span></td>
		<td class="distd1" width="11%">人员类别</td>
		<td class="detailtd2" width="22%"><span id="gz"></span></td>
        <td class="distd1" width="11%">暂住证号码</td>
		<td class="detailtd2" width="22%"><span id="zzzhm"></span></td>
    </tr>
	<tr height="20">
		<td class="distd1">暂住地址</td>
		<td colspan="5" class="detailtd2"><span id="zzdz"></span></td>
    </tr>
	<tr height="20" id="zhuxiao">
