...
<script type="text/javascript">
	...
	function qyjbxx_modifyVerify_jxy(){ //验证
	...
	function valadateYyzz(){ //营业执照编号
		...
		//if(yyzzZjbh==''){//liufeng modify 20080828
		//	canCommit=false;
	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
		        ...
		        <td class="red" nowrap>单位负责人联系方式</td>
			...
			<tr height="25">
				...
				<td class="pagetd1"  nowrap><input style="width:120px" type="text" class="inputstyle1" id="m_bafzrgmsfhm" onBlur="bafzrzjhmBlurVali();"/></td>
