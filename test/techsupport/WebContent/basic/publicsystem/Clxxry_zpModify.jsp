...
<script type="text/javascript">
	...
	function updatediv (json) { 
		$("#m_cljbxxid").attr("value",setNull(json.LClxxry_zp[0].cljbxxid));
		$("#m_clxxryzpid").attr("value",setNull(json.LClxxry_zp[0].clxxryzpid));
		$("#m_tpmc").attr("value",setNull(json.LClxxry_zp[0].tpmc));
		$("#m_tplx").attr("value",setNull(json.LClxxry_zp[0].tplx));
		$("#m_tpnr").attr("value",setNull(json.LClxxry_zp[0].tpnr));
	}	
	function modifyVerify(){
		if (!checkControlValue("m_cljbxxid","Integer",-9999999999,9999999999,null,0,"车辆基本信息ID"))
			return false;
		if (!checkControlValue("m_clxxryzpid","Integer",-9999999999,9999999999,null,0,"车辆信息人员照片ID"))
			return false;
...
<table width="100%" id="modify">
	<tr height="20">
		...
		<td class="detailtd"><input type="text" id="m_clxxryzpid" value="0"></td>
	</tr>
	<tr height="20">
