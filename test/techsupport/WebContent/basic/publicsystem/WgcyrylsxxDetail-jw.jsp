...
<div align="right"><table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td><a href="#" id="closeDiv" onclick='$("#wgcyrylsxx_detail").hideAndRemove("show");'class="close"></a></td>
    </tr>
     <tr>
      <td align="left"></td>
      <td></td>
...
<table width="100%"  cellpadding="4" cellspacing="0" class="detail" id="detail" >
	<tr>
      ...
      <td width="23%" class="detailtd2"><span id="xm"></span></td>
      <td width="26%" rowspan="16" align="center" valign="top" class="detailtd2"><table width="35%" border="0" align="center" cellpadding="8" cellspacing="0">
	...
	<tr>
		...
		<td colspan="3" class="detailtd2"><span id="hcdw"></span></td>
    </tr>
	<tr>
		<td height="22" class="distd1">联系电话</td>
	...
	<tr>
		...
		<td colspan="1" class="detailtd2"><span id="zzzhm"></span></td>
		<td class="distd1">血型</td>
		<td colspan="1" class="detailtd2"><span id="xx"></span></td>
    </tr>
	<tr>
	...
	<tr>
	  ...
	  <td colspan="4" class="detailtd2"><span id="bz"></span></td>
    </tr>
        </table> 
<div id="qyrytjxx"  >
</div>	