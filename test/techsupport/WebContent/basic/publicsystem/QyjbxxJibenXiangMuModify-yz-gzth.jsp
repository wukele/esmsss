...
<script type="text/javascript">
	...
	function qyjbxx_modifyVerify_yzhy(){ //验证
		...
		<td valign="top" class="tdbg">
			...
			<tr height="25">
		        ...
		        <td id="jyxk_fzjgConte" class="pagetd1"><input style="width:120px" type="text" class="inputstyle1" id="m_jyxkFzjg"
		        	onkeyup="htjdOnkeyupVal('m_jyxkFzjg','zhongwen');"/>
		        	<input style="width:120px" type="hidden" id="m_jyxkFzjgdm"/>
		        	</td>
			</tr>
			<tr height="25">
			...
			<tr height="25">
				...
				<td class="pagetd1" colspan="5"><input style="width:120px" type="text" class="inputstyle1" id="m_nsrq"/></td>
			</tr>
			<tr height="25">
