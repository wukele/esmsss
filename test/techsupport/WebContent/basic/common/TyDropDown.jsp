...
var pageUrldLG="<%=request.getContextPath() %>/stationList/querylistLG_stationlist.action";
divnidd="tabledatt";
//tableidd="dictTable";
//loadPage("tabledatt");
...
function setList1(pageno,url){	
	...
	if (url==null || url=="undefined"){
		url=pageUrld;
	//	if($('#t_hylbdm').val()=="N"){    //添加四川乐山内保采集点，孙旭确定20110128
	//		url=pageUrldNB;
	//	}else 
		if($('#t_hylbdm').val()=="A"){
			url=pageUrldLG;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="images/toolbar.gif">
  <tr>
    	...
    	<input id='t_zxbz' type='hidden' value='0'/>
