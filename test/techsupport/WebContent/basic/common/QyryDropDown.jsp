...
pageUrld="<%=request.getContextPath() %>/publicsystem/querylistRyDict_qyryxx.action";
divnidd="tabledatt";
//tableidd="dictTable";
//loadPage("tabledatt");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="images/toolbar.gif">
  <tr>
    	...
    	<input id='t_xm' class="inputstyle3" type='text' style="width:98%" />
    	<input id='t_zxbz' type='hidden' />
    	<input type="hidden" id="t_qybm"/>
    	</td>
