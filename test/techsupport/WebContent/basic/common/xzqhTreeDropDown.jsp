...
var itemSelect = 0;
 ...
 tree=new dhtmlXTreeObject("dictItem_treeDropDown","100%","100%",0);
  ...
  tree.setXMLAutoLoading("<c:out value="${pageContext.request.contextPath}"/>/sysadminDefault/dictItemTree_fact_tree.action?dict_code="+gdictCode+"&fact_value="+gfact_value);
  //tree.loadXML("<c:out value="${pageContext.request.contextPath}"/>/privisys/department.do?method=tree&id=0");
  tree.loadXML("<c:out value="${pageContext.request.contextPath}"/>/sysadminDefault/dictItemTree_fact_tree.action?dict_code="+gdictCode+"&fact_value="+gfact_value);
