...
<script type="text/javascript">
	...
	function updatediv (json) { 
		$("#m_bdqclxxid").attr("value",setNull(json.LBdqclxx[0].bdqclxxid));
		$("#m_t_b_bdqclxxid").attr("value",setNull(json.LBdqclxx[0].t_b_bdqclxxid));
		$("#m_id").attr("value",setNull(json.LBdqclxx[0].id));
		$("#m_ajbh").attr("value",setNull(json.LBdqclxx[0].ajbh));
		$("#m_ajxzdm").attr("value",setNull(json.LBdqclxx[0].ajxzdm));
		$("#m_ajxz").attr("value",setNull(json.LBdqclxx[0].ajxz));
		$("#m_cllxdm").attr("value",setNull(json.LBdqclxx[0].cllxdm));
		$("#m_cllx").attr("value",setNull(json.LBdqclxx[0].cllx));
		$("#m_clpp").attr("value",setNull(json.LBdqclxx[0].clpp));
		$("#m_clxh").attr("value",setNull(json.LBdqclxx[0].clxh));
		$("#m_hpzldm").attr("value",setNull(json.LBdqclxx[0].hpzldm));
		$("#m_hpzl").attr("value",setNull(json.LBdqclxx[0].hpzl));
		$("#m_hphm").attr("value",setNull(json.LBdqclxx[0].hphm));
		$("#m_csys").attr("value",setNull(json.LBdqclxx[0].csys));
		$("#m_syr").attr("value",setNull(json.LBdqclxx[0].syr));
		$("#m_ccdjrq").attr("value",setNull(json.LBdqclxx[0].ccdjrq));
		$("#m_fdjh").attr("value",setNull(json.LBdqclxx[0].fdjh));
		$("#m_clsbdh").attr("value",setNull(json.LBdqclxx[0].clsbdh));
		$("#m_cjh").attr("value",setNull(json.LBdqclxx[0].cjh));
		$("#m_sfbx").attr("value",setNull(json.LBdqclxx[0].sfbx));
		$("#m_bar").attr("value",setNull(json.LBdqclxx[0].bar));
		$("#m_ladwqhbm").attr("value",setNull(json.LBdqclxx[0].ladwqhbm));
		$("#m_ladwqh").attr("value",setNull(json.LBdqclxx[0].ladwqh));
		$("#m_ladwbm").attr("value",setNull(json.LBdqclxx[0].ladwbm));
		$("#m_ladwmc").attr("value",setNull(json.LBdqclxx[0].ladwmc));
		$("#m_lasj").attr("value",setNull(json.LBdqclxx[0].lasj));
		$("#m_lajbr").attr("value",setNull(json.LBdqclxx[0].lajbr));
		$("#m_ladh").attr("value",setNull(json.LBdqclxx[0].ladh));
		$("#m_sldwqhbm").attr("value",setNull(json.LBdqclxx[0].sldwqhbm));
		$("#m_sldwqh").attr("value",setNull(json.LBdqclxx[0].sldwqh));
		$("#m_sldwbm").attr("value",setNull(json.LBdqclxx[0].sldwbm));
		$("#m_sldwmc").attr("value",setNull(json.LBdqclxx[0].sldwmc));
		$("#m_slsj").attr("value",setNull(json.LBdqclxx[0].slsj));
		$("#m_sljbr").attr("value",setNull(json.LBdqclxx[0].sljbr));
		$("#m_sldh").attr("value",setNull(json.LBdqclxx[0].sldh));
		$("#m_bz").attr("value",setNull(json.LBdqclxx[0].bz));
		$("#m_tbdwqhbm").attr("value",setNull(json.LBdqclxx[0].tbdwqhbm));
		$("#m_tbdwqh").attr("value",setNull(json.LBdqclxx[0].tbdwqh));
		$("#m_tbdwbm").attr("value",setNull(json.LBdqclxx[0].tbdwbm));
		$("#m_tbdwmc").attr("value",setNull(json.LBdqclxx[0].tbdwmc));
		$("#m_tbtbr").attr("value",setNull(json.LBdqclxx[0].tbtbr));
		$("#m_tbsj3").attr("value",setNull(json.LBdqclxx[0].tbsj3));
		$("#m_zt").attr("value",setNull(json.LBdqclxx[0].zt));
		$("#m_scbz").attr("value",setNull(json.LBdqclxx[0].scbz));
		$("#m_lrdwbm").attr("value",setNull(json.LBdqclxx[0].lrdwbm));
		$("#m_lrdw").attr("value",setNull(json.LBdqclxx[0].lrdw));
		$("#m_lrr").attr("value",setNull(json.LBdqclxx[0].lrr));
		$("#m_lrsj").attr("value",setNull(json.LBdqclxx[0].lrsj));
		$("#m_xgdwbm").attr("value",setNull(json.LBdqclxx[0].xgdwbm));
		$("#m_xgdw").attr("value",setNull(json.LBdqclxx[0].xgdw));
		$("#m_xgr").attr("value",setNull(json.LBdqclxx[0].xgr));
		$("#m_xgsj").attr("value",setNull(json.LBdqclxx[0].xgsj));
		$("#m_spr3").attr("value",setNull(json.LBdqclxx[0].spr3));
		$("#m_spyj").attr("value",setNull(json.LBdqclxx[0].spyj));
		$("#m_sydwbm").attr("value",setNull(json.LBdqclxx[0].sydwbm));
		$("#m_sydw").attr("value",setNull(json.LBdqclxx[0].sydw));
	}	
	function modifyVerify(){
		if (!checkControlValue("m_bdqclxxid","Integer",-9999999999,9999999999,null,0,"被盗抢车辆信息ID"))
			return false;
		if (!checkControlValue("m_t_b_bdqclxxid","Integer",-9999999999,9999999999,null,0,"被盗抢_被盗抢车辆信息ID"))
			return false;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      ...
      <td ><a href="#" id="closeDiv" onclick='$("#Bdqclxx_detail").hideAndRemove("show");' class="close"></a></td>
    </tr>
</table>
<table width="100%" id="modify">
	<tr height="20">
		...
		<td class="distd">被盗抢_被盗抢车辆信息ID</td>
		<td class="detailtd"><input type="text" id="m_t_b_bdqclxxid" value="0"></td>
	</tr>
	<tr height="20">
