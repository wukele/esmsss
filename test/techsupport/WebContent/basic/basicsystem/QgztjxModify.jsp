...
<script type="text/javascript">
	...
	function updatediv (json) { 
		$("#m_qgztjxid").attr("value",setNull(json.LQgztjx[0].qgztjxid));
		$("#m_tbbh").attr("value",setNull(json.LQgztjx[0].tbbh));
		$("#m_xzqhbm").attr("value",setNull(json.LQgztjx[0].xzqhbm));
		$("#m_xzqh").attr("value",setNull(json.LQgztjx[0].xzqh));
		$("#m_xmpy").attr("value",setNull(json.LQgztjx[0].xmpy));
		$("#m_xm").attr("value",setNull(json.LQgztjx[0].xm));
		$("#m_bm").attr("value",setNull(json.LQgztjx[0].bm));
		$("#m_xbdm").attr("value",setNull(json.LQgztjx[0].xbdm));
		$("#m_xb").attr("value",setNull(json.LQgztjx[0].xb));
		$("#m_csrq").attr("value",setNull(json.LQgztjx[0].csrq));
		$("#m_gmsfhm").attr("value",setNull(json.LQgztjx[0].gmsfhm));
		$("#m_hjdbm").attr("value",setNull(json.LQgztjx[0].hjdbm));
		$("#m_hjd").attr("value",setNull(json.LQgztjx[0].hjd));
		$("#m_hjxxdz").attr("value",setNull(json.LQgztjx[0].hjxxdz));
		$("#m_xzdqbm").attr("value",setNull(json.LQgztjx[0].xzdqbm));
		$("#m_xzdq").attr("value",setNull(json.LQgztjx[0].xzdq));
		$("#m_xzdxxdz").attr("value",setNull(json.LQgztjx[0].xzdxxdz));
		$("#m_qtzjlx").attr("value",setNull(json.LQgztjx[0].qtzjlx));
		$("#m_qtzjhm").attr("value",setNull(json.LQgztjx[0].qtzjhm));
		$("#m_ajjbbm").attr("value",setNull(json.LQgztjx[0].ajjbbm));
		$("#m_ajjb").attr("value",setNull(json.LQgztjx[0].ajjb));
		$("#m_ajlbbm").attr("value",setNull(json.LQgztjx[0].ajlbbm));
		$("#m_ajlb").attr("value",setNull(json.LQgztjx[0].ajlb));
		$("#m_jyaq").attr("value",setNull(json.LQgztjx[0].jyaq));
		$("#m_djrq").attr("value",setNull(json.LQgztjx[0].djrq));
		$("#m_djr").attr("value",setNull(json.LQgztjx[0].djr));
		$("#m_ladqbm").attr("value",setNull(json.LQgztjx[0].ladqbm));
		$("#m_ladq").attr("value",setNull(json.LQgztjx[0].ladq));
		$("#m_badwbm").attr("value",setNull(json.LQgztjx[0].badwbm));
		$("#m_badw").attr("value",setNull(json.LQgztjx[0].badw));
		$("#m_tbr").attr("value",setNull(json.LQgztjx[0].tbr));
		$("#m_lxr").attr("value",setNull(json.LQgztjx[0].lxr));
		$("#m_lxfs").attr("value",setNull(json.LQgztjx[0].lxfs));
	}	
