...
$(document).ready(function() {
	pageUrl="basicsystem/querylistSh_bkry.action";
	divnid="BkryData";
	tableid="BkryTable";
	...
	delid="d_bkryid";
	modHtml="basic/basicsystem/BkryshDetail.jsp";
	  ...
	  <tr>
										<td width="54%" >
											<a href="#" class="searchbutton" id="querys"
												onClick="setPageList(1);">查询</a>	<!-- <a href="#" class="submitbutton" onclick=''>高级查询</a> -->										</td>
										<td width="46%">
									</tr>
								</table>
						  </td>
