...
<script type="text/javascript">
	...
	function addVerify(){
		...
		if (!checkControlValue("a_bjxxid","Integer",-9999999999,9999999999,null,0,"报警信息ID"))
			return false;
		if (!checkControlValue("a_qgztjxkzid","Integer",-9999999999,9999999999,null,0,"全国在逃简项快照ID"))
			return false;
...
<table width="100%" id="add">
	...
	<tr height="20">
		...
		<td class="detailtd"><input type="text" class="inputstyle"  id="a_qgztjxkzid" value="0"></td>
	</tr>
	<tr height="20">
