...
<script type="text/javascript">
	...
	function updatediv (json) { 
		$("#m_bjgzid").attr("value",setNull(json.LBjbdtj[0].bjgzid));
		$("#m_bjbdtjid").attr("value",setNull(json.LBjbdtj[0].bjbdtjid));
		$("#m_tjlx").attr("value",setNull(json.LBjbdtj[0].tjlx));
		$("#m_ywbzdm").attr("value",setNull(json.LBjbdtj[0].ywbzdm));
		$("#m_bdbzdm").attr("value",setNull(json.LBjbdtj[0].bdbzdm));
		$("#m_bdgx").attr("value",setNull(json.LBjbdtj[0].bdgx));
		$("#m_gxc").attr("value",setNull(json.LBjbdtj[0].gxc));
		$("#m_zxsx").attr("value",setNull(json.LBjbdtj[0].zxsx));
		$("#m_ljgx").attr("value",setNull(json.LBjbdtj[0].ljgx));
		$("#m_jibie").attr("value",setNull(json.LBjbdtj[0].jibie));
	}	
	function modifyVerify(){
		if (!checkControlValue("m_bjgzid","Integer",-9999999999,9999999999,null,0,"报警规则ID"))
			return false;
		if (!checkControlValue("m_bjbdtjid","Integer",-9999999999,9999999999,null,0,"报警比对条件ID"))
			return false;
...
<table width="100%" id="modify">
	<tr height="20">
		...
		<td class="detailtd"><input type="text" class="inputstyle"  id="m_bjbdtjid" value="0"></td>
	</tr>
	<tr height="20">
