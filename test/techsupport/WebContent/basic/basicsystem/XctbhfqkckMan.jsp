...
<script type="text/javascript">
	...
	$(document).ready(function() {
		pageUrl="basicsystem/querylistreplay_xctb.action";
		divnid="XctbData";
		tableid="XctbTable";
	...
	function setPageList(pageno,url){	
		if (manVerify()){
			...
			var mygrid1 = $("#"+tableid).ingrid({ 
										    ...
										    noSortColIndex:[4],
										    colWidths: ["8%","25%","35%","15%","17%"]									
										});				
			}
	}
	////查看方法重写
	function setQuery_xctbhfck(id,url){
     if(timeFlag){
	 timeFlag = false;
  ...
  function readstatus(id){
	...
	timeFlag = false;
	    ...
	    sFlag = "false";
	    var readHtml = "basic/basicsystem/XctbckqkDetail.jsp";
	    dataid = id;
  ...
  function replaystatus(id){
   ...
   if(timeFlag){
    ...
    sFlag = "false";
    var readHtml = "basic/basicsystem/XctbhfqkDetail.jsp";
    dataid = id;
    setWidth(detailid,addWidth);
	setUrl(detailid,readHtml);
		bindDocument(detailid);
  ...
  function setXiangQing(id){
		sFlag="false";
		dataid=id;
		setQuery_xctbhfck(dataid,detailHtml,detailWidth); 
  }
</script>
...
<body>
			...
			<td class="tdbg">
				<table width="100%" border="0" cellspacing="0" cellpadding="2">
					<tr>
						...
						<td width="22%" class="pagetd">
							<input type="text" class="inputstyle" id="p_fbdw"  readonly="readonly"/>
	...
	<div id="xctb_detail" class="page-layout" src="#"
		style="top: 120px; left: 160px;; overflowY: scroll;">
	</div>
