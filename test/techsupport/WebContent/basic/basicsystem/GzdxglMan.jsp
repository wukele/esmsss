			...
			var mygrid1 = $("#" + tableid).ingrid(
					{
						...
						changeHref : function(table) {
							...
							table.find("tr").each(
									function() {
										trObj = $(this);
										if (trObj.find("td:nth(8)").text() != "1") {
											trObj.find("td:last").find("a").remove();
										}
										if (trObj.find("td:nth(9)").text() != "0") {
											trObj.find("td:last").find("a:first").remove();
										}
									});
						},
						hideColIndex : [ 8,9 ],
						colWidths : [ "8%", "15%", "5%", "11%", "6%", "11%",
								"15%", "21%", "0%","0%","8%" ]
					});
		}
	}
		...
		<td class="tdbg">
			<table width="100%" border="0" cellspacing="0" cellpadding="2">
				...
				<tr>
					...
					<td width="23%" class="pagetd">
						<input type="text" id="p_minzu" class="inputstyle" readonly />
					...
					<td width="23%" class="pagetd">
						<input type="text" id="p_hjdxzqh" class="inputstyle" readonly />
