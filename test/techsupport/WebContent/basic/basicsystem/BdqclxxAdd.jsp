...
<script type="text/javascript">
	...
	function addVerify(){
		if (!checkControlValue("a_bdqclxxid","Integer",-9999999999,9999999999,null,0,"被盗抢车辆信息ID"))
			return false;
		if (!checkControlValue("a_t_b_bdqclxxid","Integer",-9999999999,9999999999,null,0,"被盗抢_被盗抢车辆信息ID"))
			return false;
		if (!checkControlValue("a_id","String",1,46,null,0,"序号"))
			return false;
		if (!checkControlValue("a_ajbh","String",1,60,null,0,"案件编号"))
			return false;
		if (!checkControlValue("a_ajxzdm","String",1,6,null,0,"案件性质代码"))
			return false;
		if (!checkControlValue("a_ajxz","String",1,60,null,0,"案件性质"))
			return false;
...
<table width="100%" id="add">
	<tr height="20">
		...
		<td class="detailtd"><input type="text" id="a_bdqclxxid" value="0"></td>
		<td class="distd">被盗抢_被盗抢车辆信息ID</td>
		<td class="detailtd"><input type="text" id="a_t_b_bdqclxxid" value="0"></td>
	</tr>
	<tr height="20">
		<td class="distd">序号</td>
		<td class="detailtd"><input type="text" id="a_id" value=""></td>
		<td class="distd">案件编号</td>
		<td class="detailtd"><input type="text" id="a_ajbh" value=""></td>
	</tr>
	<tr height="20">
		<td class="distd">案件性质代码</td>
		<td class="detailtd"><input type="text" id="a_ajxzdm" value=""></td>
		<td class="distd">案件性质</td>
		<td class="detailtd"><input type="text" id="a_ajxz" value=""></td>
	</tr>
	<tr height="20">
