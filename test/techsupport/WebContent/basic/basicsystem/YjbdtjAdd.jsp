...
<script type="text/javascript">
	...
	function addVerify(){
		if (!checkControlValue("a_yjgzid","Integer",-9999999999,9999999999,null,0,"预警规则ID"))
			return false;
		if (!checkControlValue("a_yjbdtjid","Integer",-9999999999,9999999999,null,0,"预警比对条件ID"))
			return false;
...
<table width="100%" id="add">
	<tr height="20">
		...
		<td class="detailtd"><input type="text" class="inputstyle"  id="a_yjbdtjid" value="0"></td>
	</tr>
	<tr height="20">
