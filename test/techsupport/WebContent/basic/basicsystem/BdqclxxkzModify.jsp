...
<script type="text/javascript">
	...
	function updatediv (json) { 
		$("#m_bjxxid2").attr("value",setNull(json.LBdqclxxkz[0].bjxxid2));
		$("#m_bdqclxxkzid").attr("value",setNull(json.LBdqclxxkz[0].bdqclxxkzid));
		$("#m_id").attr("value",setNull(json.LBdqclxxkz[0].id));
		$("#m_cllxdm").attr("value",setNull(json.LBdqclxxkz[0].cllxdm));
		$("#m_cllx").attr("value",setNull(json.LBdqclxxkz[0].cllx));
		$("#m_clpp").attr("value",setNull(json.LBdqclxxkz[0].clpp));
		$("#m_clxh").attr("value",setNull(json.LBdqclxxkz[0].clxh));
		$("#m_hpzldm").attr("value",setNull(json.LBdqclxxkz[0].hpzldm));
		$("#m_hpzl").attr("value",setNull(json.LBdqclxxkz[0].hpzl));
		$("#m_hphm").attr("value",setNull(json.LBdqclxxkz[0].hphm));
		$("#m_csys").attr("value",setNull(json.LBdqclxxkz[0].csys));
		$("#m_syr").attr("value",setNull(json.LBdqclxxkz[0].syr));
		$("#m_ccdjrq").attr("value",setNull(json.LBdqclxxkz[0].ccdjrq));
		$("#m_fdjh").attr("value",setNull(json.LBdqclxxkz[0].fdjh));
		$("#m_clsbdh").attr("value",setNull(json.LBdqclxxkz[0].clsbdh));
		$("#m_cjh").attr("value",setNull(json.LBdqclxxkz[0].cjh));
		$("#m_sfbx").attr("value",setNull(json.LBdqclxxkz[0].sfbx));
		$("#m_bar").attr("value",setNull(json.LBdqclxxkz[0].bar));
		$("#m_ladwqhbm").attr("value",setNull(json.LBdqclxxkz[0].ladwqhbm));
		$("#m_ladwqh").attr("value",setNull(json.LBdqclxxkz[0].ladwqh));
		$("#m_ladwbm").attr("value",setNull(json.LBdqclxxkz[0].ladwbm));
		$("#m_ladwmc").attr("value",setNull(json.LBdqclxxkz[0].ladwmc));
		$("#m_lasj").attr("value",setNull(json.LBdqclxxkz[0].lasj));
		$("#m_lajbr").attr("value",setNull(json.LBdqclxxkz[0].lajbr));
		$("#m_ladh").attr("value",setNull(json.LBdqclxxkz[0].ladh));
		$("#m_sldwqhbm").attr("value",setNull(json.LBdqclxxkz[0].sldwqhbm));
		$("#m_sldwqh").attr("value",setNull(json.LBdqclxxkz[0].sldwqh));
		$("#m_sldwbm").attr("value",setNull(json.LBdqclxxkz[0].sldwbm));
		$("#m_sldwmc").attr("value",setNull(json.LBdqclxxkz[0].sldwmc));
		$("#m_slsj").attr("value",setNull(json.LBdqclxxkz[0].slsj));
		$("#m_sljbr").attr("value",setNull(json.LBdqclxxkz[0].sljbr));
		$("#m_sldh").attr("value",setNull(json.LBdqclxxkz[0].sldh));
		$("#m_bz").attr("value",setNull(json.LBdqclxxkz[0].bz));
		$("#m_tbdwqhbm").attr("value",setNull(json.LBdqclxxkz[0].tbdwqhbm));
		$("#m_tbdwqh").attr("value",setNull(json.LBdqclxxkz[0].tbdwqh));
		$("#m_tbdwbm").attr("value",setNull(json.LBdqclxxkz[0].tbdwbm));
		$("#m_tbdwmc").attr("value",setNull(json.LBdqclxxkz[0].tbdwmc));
		$("#m_tbtbr").attr("value",setNull(json.LBdqclxxkz[0].tbtbr));
		$("#m_tbsj3").attr("value",setNull(json.LBdqclxxkz[0].tbsj3));
		$("#m_zt").attr("value",setNull(json.LBdqclxxkz[0].zt));
		$("#m_scbz").attr("value",setNull(json.LBdqclxxkz[0].scbz));
		$("#m_lrdwbm").attr("value",setNull(json.LBdqclxxkz[0].lrdwbm));
		$("#m_lrdw").attr("value",setNull(json.LBdqclxxkz[0].lrdw));
		$("#m_lrr").attr("value",setNull(json.LBdqclxxkz[0].lrr));
		$("#m_lrsj").attr("value",setNull(json.LBdqclxxkz[0].lrsj));
		$("#m_xgdwbm").attr("value",setNull(json.LBdqclxxkz[0].xgdwbm));
		$("#m_xgdw").attr("value",setNull(json.LBdqclxxkz[0].xgdw));
		$("#m_xgr").attr("value",setNull(json.LBdqclxxkz[0].xgr));
		$("#m_xgsj").attr("value",setNull(json.LBdqclxxkz[0].xgsj));
		$("#m_spr3").attr("value",setNull(json.LBdqclxxkz[0].spr3));
		$("#m_spyj").attr("value",setNull(json.LBdqclxxkz[0].spyj));
		$("#m_sydwbm").attr("value",setNull(json.LBdqclxxkz[0].sydwbm));
		$("#m_sydw").attr("value",setNull(json.LBdqclxxkz[0].sydw));
	}	
	function modifyVerify(){
		if (!checkControlValue("m_bjxxid2","Integer",-9999999999,9999999999,null,0,"报警信息ID"))
			return false;
		if (!checkControlValue("m_bdqclxxkzid","Integer",-9999999999,9999999999,null,0,"被盗抢车辆信息快照ID"))
			return false;
...
<table width="100%" id="modify">
	<tr height="20">
		...
		<td class="detailtd"><input type="text" id="m_bdqclxxkzid" value="0"></td>
	</tr>
	<tr height="20">
