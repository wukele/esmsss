...
<script type="text/javascript">
	...
	function addVerify(){
		...
		if (!checkControlValue("a_gxdwzd","String",1,60,null,0,"管辖单位字段"))
			return false;
		if (!checkControlValue("a_yjjb","String",1,2,null,0,"预警级别"))
			return false;
		if (!checkControlValue("a_yjfs","String",1,60,null,0,"预警方式"))
			return false;
...
<table width="100%" id="add">
	...
	<tr height="20">
		...
		<td class="detailtd"><input type="text" class="inputstyle"  id="a_yjjb" value=""></td>
	</tr>
	<tr height="20">
		<td class="distd">预警方式</td>
		<td class="detailtd"><input type="text" class="inputstyle"  id="a_yjfs" value=""></td>
