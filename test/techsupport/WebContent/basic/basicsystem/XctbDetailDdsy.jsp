...
$(document).ready(function() {
	...
	function ddxctb_setDetail(){
		setParams("q_");
		jQuery.post(ddxctb_detailUrl,params,ddupdatediv,"json");
	}
	function ddupdatediv(json){
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      <td align="left" class="title1">协查通报详细信息</td>
...
<table width="100%" id="detail" cellpadding="4" cellspacing="0"  class="tableborder" >
	<tr>
      ...
      <textarea id="jsdwmc" name="tzcs" theme="simple" style="font-size:12px;WIDTH:500;BORDER: #A3B4CD 1px solid;height:50px;" readonly="true">
      </textarea>
      </td>	
  </tr>
  <tr>
  ...
  <tr>
	...
	<tr>
 	...
 	<tr>
		...
		<textarea id="fbnr" name="tzcs" theme="simple" style="font-size:12px;WIDTH:500;BORDER: #A3B4CD 1px solid;height:50px;" readonly="true">
        </textarea>
		</td>
	</tr>
    <tr>
