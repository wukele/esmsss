...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
            	...
            	<tr>
                	<td class="tdContent" >
                  		<table width="100%" border='0'  align="center" cellpadding="1" cellspacing="1" class="listTable">
  							<tr>
    							<td valign="top">
       								<div id="depart_treeRole" class="titleTablenei"></div>
	    						</td>
							</tr>	
       					</table>   
                	</td>
    ...
    <td valign="top" align="left">
		<div class="textdiv" id="deptManagerRole" onload='$("deptManagerRole").show("slow");'>
      	</div>
    </td>
  </tr>
</table>
...
<script>
$("#depart_treeRole").css({height:pageHeight-148});
var itemSelect = 0;
//var parentdeptid = "<c:out value='${parentdeptid}'/>";
var parentdeptid = '<%=parentdeptid%>';
 tree=new dhtmlXTreeObject("depart_treeRole","100%","100%",parentdeptid);
  //tree=new dhtmlXTreeObject("depart_treeRole","100%","100%",parentID);
...
function rightMainRole(treeDepartid){
	$("#deptManagerRole").empty();
			$("#deptManagerRole").load("sysadminDefault/queryRole_role.action?departid="+treeDepartid);
			$("#deptManagerRole").show("slow"); 
}
//页面加载时，自动调用方法
var treeDepartid ='';
