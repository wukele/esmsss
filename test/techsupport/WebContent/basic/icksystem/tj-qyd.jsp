...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		pageUrl="icksystem/querylistQyd_cjdtjrb.action";
		//ExcelURL
		excelUrl="icksystem/querylistExcelQyd_cjdtjrb.action";
		searchLongUrl="icksystem/querylistExcelQydTemp_cjdtjrb.action";
	});
