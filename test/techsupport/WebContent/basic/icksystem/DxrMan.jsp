...
<table width="100%" cellpadding="0" cellspacing="0"class="tableborder">
    ...
    <td class="tdbg">
    	<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<tr>
				<td width="10%" class="pagetd"><input id="pxr" type="radio" name="xrtype" value="pxr" checked>批写入</td>
				<td width="9%" class="pagedistd">批次号</td>
				<td width="20%" class="pagetd"><input type="text" title="输入18位批次号" class="inputstyle" id="p_pch" onpropertychange="queryStartNumAndWriteCount();"></td>
				<td width="10%" class="pagedistd">开始顺序号</td>
				<td width="20%" class="pagetd"><input type="text" class="inputstyle" id="p_kssxh"></td>
				<td width="10%" class="pagedistd">本次电写入数量</td>
				<td width="21%" class="pagetd"><input type="text" class="inputstyle" id="p_bcdxrsl"> 
				张卡片</td>
			</tr>
			<tr>
				<td class="pagetd"><input id="zdyxr" type="radio" name="xrtype" value="zdyxr">自定义写入</td>
				<td class="pagedistd">从业人员编号</td>
				<td class="pagetd"><input type="text" class="inputstyle" id="c_cyrybh" value=""></td>
