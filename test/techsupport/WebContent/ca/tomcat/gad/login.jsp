...
<%
	   ...
	   String basePath = "https://"+request.getServerName()+":7443"+path+"/login-ca1.jsp"; 
...
function update_page (json) { //回传函数实体，参数为XMLhttpRequest.responseText
      ...
      if (json.result=="success"){
    	 	...
    	 	var reurl="<%=logonURL%>";
          	...
          	}else if(usertype.indexOf("122")!=-1 || usertype.indexOf("123")!=-1){
  			 	window.location=reurl+"15";
  	 		}else{
...
<tr>
	...
	<tr>
        ...
        <tr>
          <td width="%2"></td>
          <td width="32%"><a href="#"  class="loginbotton" onclick='fnca()'>CA登录</a></td>
...
<tr>
		<td  width="243" height="74" valign="bottom" background="images/login_04.gif" >
			<TABLE>
				<TR><TD width="10PX">&nbsp;</TD><TD style="FONT: 12px Tahoma;">版本号：V1.1(2010.5.10)</TD></TR>
