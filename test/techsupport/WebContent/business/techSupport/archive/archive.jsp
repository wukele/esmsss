...
<div id="feedback" style="margin-left:auto; margin-right:auto; margin-top:auto; width: 840px;">
	<div class="row">
		<div class="column">
	...
	<div class="row">
		<div class="column" style="width: 800px;">
			<div>
				...
				<textarea class="item inputstyle" style="width:700px ! important;height: 78px;" name="archiveSt.comments" id="p_comments"></textarea>
			</div>
			<div class="clear-column"></div>
		</div>
