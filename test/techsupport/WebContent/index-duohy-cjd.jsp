...
<table width="1020" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="144" background="images/logo_all.jpg" class="logofont" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
            <td height="29"></td>
          </tr>
      <tr>
        <td width="79%" style="white-space:nowrap;"><div id="yongHuXxDiv" style="width:600px; margin-left:108px; margin-top:55px;">当前用户:<%=username %>（<%=departmentname %>）今日共有<span  id="loginNum"></span>个，全部共有<span  id="loginSum"></span>个用户登录</div></td>
...
<table width="1020" border="0" align="center" cellpadding="0" cellspacing="0" height="100%">
  <tr>
    ...
    <td width="764" valign="top" id="duoHangYeNrTd"></td>
  </tr>
</table>
<table border="0" align="center" cellpadding="0" cellspacing="0">
  <tr><td width="985"  height="65" align="center" valign="top" background="images/copybg.jpg" style="background-repeat:no-repeat; padding-top:20px;" >copyright@2010 北京航天金盾科技有限公司版权所有</td> 
  </tr>
</table>
