...
public class Bkry_kz  {
	...
	/** @ --布控人员快照ID--bkrykzid--Integer--10-- */
	private Integer bkrykzid;
	...
	/** @ 布控人员快照ID(bkrykzid) */
	public Integer getBkrykzid() {
		return bkrykzid;
	}

	public void setBkrykzid(Integer bkrykzid) {
		this.bkrykzid = bkrykzid;
	}
