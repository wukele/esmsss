...
public class Qgztjx  {
	...
	/** @ --全国在逃简项ID--qgztjxid--Integer--10-- */
	private Integer qgztjxid;
	...
	/** @ 全国在逃简项ID(qgztjxid) */
	public Integer getQgztjxid() {
		return qgztjxid;
	}

	public void setQgztjxid(Integer qgztjxid) {
		this.qgztjxid = qgztjxid;
	}
