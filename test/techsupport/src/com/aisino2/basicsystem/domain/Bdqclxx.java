...
public class Bdqclxx  {
	...
	/** @ --被盗抢_被盗抢车辆信息ID--t_b_bdqclxxid--Integer--10-- */
	private Integer t_b_bdqclxxid;
	...
	public Integer getT_b_bdqclxxid() {
		return t_b_bdqclxxid;
	}

	public void setT_b_bdqclxxid(Integer t_b_bdqclxxid) {
		this.t_b_bdqclxxid = t_b_bdqclxxid;
	}
	...
	public Date getLasjF() {
		return lasjF;
	}

	public void setLasjF(Date lasjF) {
		this.lasjF = lasjF;
	}

	public Date getLasjT() {
		return lasjT;
	}

	public void setLasjT(Date lasjT) {
		this.lasjT = lasjT;
	}
}
