...
public class Bdqclxxkz  {
	...
	/** @ --被盗抢车辆信息快照ID--bdqclxxkzid--Integer--10-- */
	private Integer bdqclxxkzid;
	...
	public Integer getBdqclxxkzid() {
		return bdqclxxkzid;
	}

	public void setBdqclxxkzid(Integer bdqclxxkzid) {
		this.bdqclxxkzid = bdqclxxkzid;
	}
