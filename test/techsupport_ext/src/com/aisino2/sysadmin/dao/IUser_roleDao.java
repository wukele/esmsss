...
public interface IUser_roleDao {
	...
	List<User_role> getListForPage(User_role user_role, int pageNo,int pageSize,String sort,String desc);
	...
	List<User_role> getUser_roleListByUserid(User_role user_role);
	  ...
	  void deleteRoleUserByUser(User user);
	  void deleteRoleUserByRole(Role role);
}
