...
<script type="text/javascript">
	Ext.onReady(function(){  
		...
		new Ems.plugin.Navigator({renderTo:'navigator',img:'nativator.jpg',width:604,height:54,
			items:[new Ems.plugin.NavigatorItem({img:'testmenu1.png',imgAtv:'testmenu1_act.png',width:78,height:29,title:'痴汉'}),
			       new Ems.plugin.NavigatorItem({img:'testmenu2.png',imgAtv:'testmenu2_act.png',width:78,height:29,title:'痴女'})]});
		/*
