...
<script type="text/javascript" src="<%=path %>/pages/admin/pageAdmin/TplPageComm/PagingMemoryProxy.js"></script>
<script type="text/javascript" src="<%=path %>/pages/admin/pageAdmin/TplPageComponentMgr/ComponentResourceView.js"></script>
