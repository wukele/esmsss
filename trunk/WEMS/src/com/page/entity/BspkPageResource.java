...
/**
 * BspkPageResource entity. @author MyEclipse Persistence Tools
 */

public class BspkPageResource implements java.io.Serializable {
	...
	/** default constructor */
	public BspkPageResource() {
	}

	/** full constructor */
	public BspkPageResource(String pageResource, String xtypeCode,
			Integer resourceTop, Integer resourceLeft, Integer resourceWidth,
			Integer resourceHeight, String valueId, String config,
			String baseCls) {
