...
/**
 * TplPageResource entity. @author MyEclipse Persistence Tools
 */

public class TplPageResource implements java.io.Serializable {
	...
	/** default constructor */
	public TplPageResource() {
	}

	/** full constructor */
	public TplPageResource(String pageResource, String xtypeCode,
